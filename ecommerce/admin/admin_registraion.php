...
<form method='POST'   action="">
  <div class="container">
    ...
    <input type="password" autocomplete='off' placeholder="Repeat Password" name="psw-repeat" id="psw-repeat" required>
    <hr>
    <p>By creating an account you agree to our <a href="#">Terms & Privacy</a>.</p>

    <button class='bg-info p-2 border-0 m-3' style="border-radius:5px;" name='insert_brand' >Register</button><br>
